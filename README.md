...
[inria publications](http://artis.imag.fr/Publications/)  
[inria boissonat papers](http://www-sop.inria.fr/geometrica/publications/Author/BOISSONNAT-JD.html)  
[jovan popovich](http://people.csail.mit.edu/jovan/)  
[all siggrapg papers](http://kesen.realtimerendering.com/)  
[pixar research](http://graphics.pixar.com/)  
[university colledge of London - computer science publications](http://www0.cs.ucl.ac.uk/staff/J.Kautz/publications/)  
[standford fedwik papers](http://physbam.stanford.edu/~fedkiw/)  
[Evasion papers french](http://www-evasion.imag.fr/Publications/index.php?idAuthor=15)  
[Jule bloomenthal papers (metaballs etc)](http://www.unchainedgeometry.com/jbloom/papers.html)  
...
[flock behavior based on influence map](http://scholar.googleusercontent.com/scholar?q=cache:nX2PqgAQgUEJ:scholar.google.com/+Jonas+Flensbak+flocking&hl=fr&as_sdt=0,5)  
...
[2D polygon cleaning and simplification](http://www.cs.sunysb.edu/~algorith/files/simplifying-polygons.shtml)  
[GPU Gems 1](http://developer.download.nvidia.com/books/HTML/gpugems/gpugems_part01.html)  
[GPU Gems 2](http://http.developer.nvidia.com/GPUGems2/gpugems2_part01.html)  
[lots of cool 2D texture, spline infos](http://www.blackpawn.com/texts/default.html)  
...
[fine tone control in harware hatching](http://research.microsoft.com/en-us/um/people/hoppe/finetone.pdf)  

## **animation**  
[statistical processing of human motion data](http://www.val.ics.tut.ac.jp/VAL05/project/geostat/geostat.html)  
[learning physics based motion style with non linear inverse optimisation](http://grail.cs.washington.edu/projects/charanim/paper0129_final.pdf)  
[near optimal character animation with continuous control](http://grail.cs.washington.edu/projects/graph-optimal-control/)  
[parallel transport, moving reference frame along curve ](http://www.unchainedgeometry.com/jbloom/pdf/ref-frames.pdf)  

## **rigid bodies**  
[Nonconvex Rigid Bodies with Stacking](http://www.cs.ubc.ca/~rbridson/docs/rigid_bodies.pdf)  
[Fast Frictional Dynamics for Rigid Bodies](http://www.research.rutgers.edu/~kaufman/KaufEdPai_ffdfrb05.pdf)  

## **fluid**  
[joe Stam publications](http://www.dgp.toronto.edu/~stam/reality/Research/pub.html)  
[sand as fluid](http://www.cs.ubc.ca/~rbridson/docs/zhu-siggraph05-sandfluid.pdf)  
...
[realtime fake ambient occlusion](http://http.download.nvidia.com/developer/GPU_Gems_2/GPU_Gems2_ch14.pdf)  
[ambient occlusion GLSL](http://www.ozone3d.net/tutorials/ambient_occlusion.php)  

## **springs**  
[spring model](http://www.gamasutra.com/view/feature/3032/exploring_spring_model.php)  
...
[collision detection and response](http://www.peroxide.dk/download/tutorials/tut10/pxdtut10.html)  
[improved collision detection and response](http://www.peroxide.dk/papers/collision/collision.pdf)  
[collision technique](http://www.metanetsoftware.com/technique.html)  
[Collision and Interference Detection in Real Time Using Graphics Hardware](http://www.cs.ubc.ca/grads/resources/thesis/Nov03/David_Knott.pdf)  
[collision detection algorithms](http://www.gamespp.com/algorithms/collisiondetection/)  

## **RIG**  
[advanced spine controls](http://www.peachpit.com/articles/article.aspx?p=102262&seqNum=4)  
[Skinning Characters using Surface-Oriented Free-Form Deformations](http://www.dgp.toronto.edu/~karan/pdf/wrap.pdf)  
[space deformations sum up](http://www.dgp.toronto.edu/~silex/Publications/spaceDeformation.pdf)  
[Wires deformer](http://dl.acm.org/citation.cfm?id=280946&bnc=1)  
[Swirling-Sweepers: Constant-Volume Modeling](http://www-evasion.inrialpes.fr/Publications/2004/ACWK04a/ACWK04.pdf)  
[Realistic Skeleton Driven Skin Deformation](http://nccastaff.bournemouth.ac.uk/jzhang/PDF_Files/XSY_JJZ_2006_ICCSA_01.pdf)  
...
## **data structure**  
[DT-Grid data structure for high resolution level set simulations](http://code.google.com/p/dt-grid/)  
...
## **threading**  
[microsoft multiple threads](http://msdn.microsoft.com/en-us/library/ms684254.aspx)  
[openMP](http://openmp.org/wp/)  
[pthread prog multitache](http://franckh.developpez.com/tutoriels/posix/pthreads/#LI)  

## **physics lib**  
[physbam full suit of rigid body fluid sim](http://physbam.stanford.edu/)  
...
[adding protocol to mozilla](http://www.nexgenmedia.net/docs/protocol/)  

## **vegetation**  
[ivy generator](http://graphics.uni-konstanz.de/~luft/ivy_generator/)  

## **CG**  
[Flipcode portal](http://www.flipcode.com/portal/)  
[Graphic Gems code](http://tog.acm.org/resources/GraphicsGems/)  
[designing a modern render engine](http://www.cg.tuwien.ac.at/research/publications/2007/bauchinger-2007-mre/)  
[devmaster game developpement tutorials](http://devmaster.net/)  
[chris lomont pleins de ressources sur differents sujets (rendu, subdiv...) ](http://www.lomont.org/Software/)  
[Fur in directX and OpenGL](http://www.xbdev.net/directx3dx/specialX/Fur/index.php)  
[rhythm and hues hair rendering](http://www.rhythm.com/~ivan/hairRender.html)  
[Amd pratical hair rendering](http://developer.amd.com/wordpress/media/2012/10/Scheuermann_HairSketch.pdf)  
[thesis realtime fur](http://www.gamecareerguide.com/features/206/honors_thesis_realtime_rendering_.php)  
[volume vizualiser soft](http://www.cs.utah.edu/~jmk/simian/download.htm)  
...
[jurajTomori] (https://jurajtomori.wordpress.com)
